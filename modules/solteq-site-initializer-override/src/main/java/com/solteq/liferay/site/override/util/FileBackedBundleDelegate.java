...
public class FileBackedBundleDelegate {
    ...
    public FileBackedBundleDelegate(
            BundleContext bundleContext, File file, JSONFactory jsonFactory, String symbolicName) throws Exception {
    ...
    public Enumeration<URL> findEntries(String path, String filePattern, boolean recurse) throws IOException {
        ...
        if (recurse) {
            Files.walkFileTree(searchPathObject, new SimpleFileVisitor<Path>() {
    ...
    public Dictionary<String, String> getHeaders(String locale) {
        return MapUtil.singletonDictionary("Liferay-Site-Initializer-Name", _siteInitializerName);
    }
